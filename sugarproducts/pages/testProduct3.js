...
console.log("lala",tags)
console.log("tags",imgtags)
	return (
		<div>
			{/* <div>
				<Head>
                                        ...
                                        return(
                                            <div className="img-fluid d-block">
                                                <div className="pb-1">
                                                    ...
                                                    <img src={`/${elem2[0].toUpperCase()}${elem2.slice(1)}.png`}  />
                                                </div>
                                            </div>
                                        )
                                    })
...
export async function getStaticProps() {
	...
	var config = {
		method: 'get',
		url:
			'https://qa.api.sugarcosmetics.com/products/qa/getProductsv2?handle=bride-tribe-kit',
		headers: {}
	};
