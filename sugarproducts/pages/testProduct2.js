        ...
        <div>
            ...
            <div style={{ overflowX: 'hidden' }}>
                <div className="fixed-top" style={{ backgroundColor: 'white', height:"450px"}}>
					...
					<div className="fixed-top" style={{width:"100px",height:"30px",backgroundColor:"yellow",marginTop:"55px"}}>
					{/* {productData.resbody.tags.split(",").map((elem)=>{
						<div className="img-fluid d-block fixed-top" style={{width:"60px",height:"30px",backgroundColor:"yellow",marginTop:"50px"}} >
							{elem.trim().toLowerCase()=="Alcohol Free"&& (
                               <div className="pb-1">
                                 <p style={{backgroundColor:"yellow",color:"black"}}>{elem[0]}</p>
                               </div>
                             )}
						</div>
					})} */}
					{/* {productData && productData.resbody.tags.split(",").map((elem1)=>{
						return(
							<div>{elem1}</div>
						)
					})} */}
                    ...
                    <div className="mt-5"></div>
                        <div className="row" style={{paddingTop:"15px",paddingBottom:"10px"}}>
                            ...
                            <div className="col-8 col-sm-7 col-md-4 col-lg-2">
                             ...
                             {/* <div className="fixedBottom d-flex align-items-center shadow-sm" style={{height:"40px",width:"90px",borderRadius:"20px 20px 20px 20px",marginTop:"-255px",marginLeft:"-35px",backgroundColor:"red",position:"absolute"}}> */}
                                   {/* <span><img src="../star_filled.png" alt="Rating star" style={{height:"25px",marginLeft:"-25px"}}/></span> */}
                                   {/* <span><small className="text-muted" style={{fontSize:"15px",marginRight:"15px"}}>5(1)</small></span> */}
                               {/* </div> */}
                            </div>
...
export async function getStaticProps() {
	...
	var config = {
		method: 'get',
		url:
			'https://qa.api.sugarcosmetics.com/products/qa/getProductsv2?handle=plush-crush-creme-crayon',
		headers: {}
	};
